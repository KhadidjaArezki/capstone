...
class TestPricelee(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.manager_token = os.environ.get('TEST_TOKEN')
        self.admin_token = os.environ.get('TEST_TOKEN')
        self.new_user = {
        ...
        self.new_deal = {
            'deal_name':
                ...
                S2722DGM Featuring FreesSync Premium''',
            'deal_link': 'https://deals.dell.com/en-us/productdetail/ag5n',
            'deal_image':
                '''https://snpi.dell.com/snp/images/
                products/large/en-us~210-AZZP/210-AZZP.jpg''',
            'deal_price': 299.99,
            'deal_currency': 'USD',
            'deal_store': 'Dell'
        }
        ...
        self.new_unauth_alert = {
            ...
            'product_id': '110538092605',
            'product_name':
                'Laptop battery for DELL Latitude 6MT4T E5470 E5570 7.6V 62Wh',
            'product_link':
                '''https://cgi.sandbox.ebay.com/
                Laptop-battery-DELL-Latitude-6MT4T-
                E5470-E5570-7-6V-62Wh-/110538092605''',
            'product_image':
                '''https://thumbs2.sandbox.ebaystatic.com
                /m/m24uZs-gnzxrtT1_19PUQxw/140.jpg''',
    ...
    def test_get_recent_alerts_200(self):
        ...
        response = self.client().post('/recent_alerts',
                            json=self.get_auth_alerts)
        response_data = json.loads(response.data)
    ...
    def test_add_alert_200(self):
        ...
        response = self.client().post('/alerts/add',
                            json=self.new_auth_alert)
        response_data = json.loads(response.data)
    ...
    def test_edit_alert_200(self):
        ...
        response = self.client().patch('/alerts',
                            json=self.edit_auth_alert)
        response_data = json.loads(response.data)
    ...
    def test_delete_alert_200(self):
        ...
        response = self.client().delete('/alerts',
                            json=self.del_auth_alert)
        response_data = json.loads(response.data)
